def test_auth_success(flask_client, mongodb_set_for_test, info_test_care_worker):
    flask_client.post(
        '/care/signup',
...
def test_auth_nonexistence_id(flask_client, mongodb_set_for_test, info_test_care_worker):
    flask_client.post(
        'care/signup',
        json=info_test_care_worker
    )
...
def test_auth_wrong_password(flask_client, mongodb_set_for_test, info_test_care_worker):
    flask_client.post(
        'care/signup',
        json=info_test_care_worker
    )
